...
typedef enum {HOPPER_OKAY=0, HOPPER_ERR_SENSOR1=1, HOPPER_ERR_SENSOR2=2, HOPPER_ERR_SHORT_COIN_IMPULSE=3, HOPPER_ERR_UNEXPECTED_COIN=4, HOPPER_ERR_EARLY_COIN=5} hopperErrorEnum;
